...
import { authCurrentUser, authlogout } from 'components/store/actions';
import { Avatar, Typography } from 'components/atoms';
import { removeItemLocalStorage } from 'components/utils/localstorage';
    ...
    >
      ...
      >
        ...
        <Link href={`/change-password`} className=''>
          <span className='text-[#434349] font-medium text-sm px-4'>
            Change Password
          </span>
        </Link>
