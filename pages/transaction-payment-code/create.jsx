import { Button, Modal, Radio, Typography } from "@atoms";
import { CORPORATE_FETCH_DETAIL } from "@constants/Corporate";
...
import { GenerateForm, MainLayout } from "@organisms";
      ...
      if (payment_code_type === "house-call") {
        ...
        const newHouseCallData = {
          ...
          transactionDate: houseCallFormValue.schedule?.bookingDate
            ...
            : new Date().toISOString(),
          additionalCost: parseInt(String(houseCallFormValue.additionalCost).replace(".", "")) || 0,
          ...
          >
            <Typography>
              {ParseMessage(
                ...
                corporate?.detail &&
                  corporate?.detail?.corporateType === "Corporate"
                  ? corporate?.detail?.pics[corporate?.detail?.pics.findIndex(x => x.title === "Operasional")]?.contact
